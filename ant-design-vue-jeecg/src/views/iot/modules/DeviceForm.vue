        ...
        <a-row>
          ...
          <a-col :span="24" >
            <a-form-item label="设备地址" :labelCol="labelCol" :wrapperCol="wrapperCol">
              ...
              <a-button @click="handleAddress" type="primary">校验</a-button>
            </a-form-item>
          </a-col>
          <a-col :span="24" >
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          ...
          checkRemoteAddress: "/iot/device/checkRemoteAddress",
          deviceProbe: {
            list: '/iot/device/queryDeviceProbeByMainId',
            getAvailableProbes: "/iot/device/getAvailableProbes",
          },
        }
      }
    },
    ...
    methods: {
      ...
      handleAddress: function () {
        ...
        let params = {deviceIp:this.form.getFieldValue("deviceIp")};
        console.log(params)
        getAction(this.url.checkRemoteAddress, params).then(res=>{
          console.log(res)
          if(res.success){
            let newoptions = []
            ...
            this.deviceProbeTable.columns[0].options = newoptions
            this.$message.info("设备地址校验成功")
          }else{
            this.$message.error("设备地址校验失败")
          }
        }).catch(()=>{
          this.$message.error("设备地址校验失败")
        })
