<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('接入点配置表')">导出</a-button>
    ...
    <onboardPoint-modal ref="modalForm" @ok="modalFormOk"></onboardPoint-modal>
  </a-card>
</template>
...
<script>
  ...
  import OnboardPointModal from './modules/OnboardPointModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'

  export default {
    name: "OnboardPointList",
